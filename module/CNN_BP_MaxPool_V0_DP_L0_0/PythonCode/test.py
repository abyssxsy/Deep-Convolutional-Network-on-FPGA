...
import cPickle
import utils
utils.PROJ_NAME = 'CNN_BP_MaxPool_V0_DP_L0_0'
TEST_DATA_PATH = os.path.join(os.getenv('CNN_TEST_DATA_PATH'),'max_pool_large')
...
def test(filename='data.bin'):
    ...
    cnn.__getattribute__('%s_writeLMemBytes' %(utils.PROJ_NAME))(
    ...
    res_z2_grad = cnn.__getattribute__('%s_readLMem' %(utils.PROJ_NAME))(
