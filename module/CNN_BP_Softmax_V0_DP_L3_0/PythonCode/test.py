...
import cPickle
import utils
utils.PROJ_NAME = 'CNN_BP_Softmax_V0_DP_L3_0'
...
def test(filename='data.bin'):
    ...
    res_b_grad,res_w_grad = cnn.__getattribute__('%s' %(utils.PROJ_NAME))(
        param_ni = ni,
    ...
    res_x_grad = cnn.__getattribute__('%s_readLMem' %(utils.PROJ_NAME))(
